...
\begin{figure}[htb]
    ...
    \end{center}
    \legend{Fonte: \citautoryear{GDCVault2:online}}
\end{figure}
...
\begin{figure}[htb]
    ...
    \end{center}
    \legend{Fonte: \citautoryear{Geirange16:online}}
\end{figure}
...
\begin{figure}[htb]
    ...
    \end{center}
    \legend{Fonte: \citautoryear{KillinVi68:online}}
\end{figure}
...
\begin{figure}[htb]
    ...
    \end{center}
    \legend{Fonte: \citautoryear{MesaVerd44:online}}
\end{figure}
...
\begin{figure}[htb]
    ...
    \end{center}
    \legend{Fonte: \citautoryear{MayaPyra92:online}}
\end{figure}
...
\legend{Fonte: \citautoryear{gabaldon2004outlander}} \end{figure}
...
\legend{Fonte: \citautoryear{reesfilha}} \end{figure}
...
\legend{Fonte: \citautoryear{dessencanto}} \end{figure}
...
\legend{Fonte: \citautoryear{avengers}} \end{figure}
...
\legend{Fonte: \citautoryear{godofwar}} \end{figure}
...
\begin{figure}[!htb]
    ...
    \end{center} \legend{Fonte: \citautoryear{carolyn_2016}} \end{figure}
...
\legend{Fonte:~\citautoryear{storniolo2009out}} \end{figure}
...
\legend{Fonte:~\citautoryear{heyder1997anasazi}} \end{figure}
...
\legend{Fonte: \citautoryear{siempre}} \end{figure}

\clearpage

\subsection{\textit{The Ghost of a Tale}} Segundo o site de \citeonline{Ghostofa36:online}  ``Você é Tilo,
...
\legend{Fonte: \citautoryear{Ghostofa36:online}} \end{figure}
...
\legend{Fonte: \citautoryear{Moss18}} \end{figure}
...
\legend{Fonte: \citautoryear{zeldaWind}} \end{figure}
